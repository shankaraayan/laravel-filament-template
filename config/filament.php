    ...
    */
    ...
    'auth' => [
        ...
        'pages' => [
            ...
            'newLogin' => \App\Filament\Auth\Login::class,

            'request-password-reset' => \App\Filament\Auth\RequestPasswordReset::class,
            'password-reset' => \App\Filament\Auth\PasswordReset::class,
        ],
    ],
